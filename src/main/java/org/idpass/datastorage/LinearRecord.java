...
/**
 * Definition of a file for multiple sotrage of structural data. Once the file
 * is filled completely with data records, further writing to the file is not
 * possible unless this is cleared.
 * 
 * @author Jorge Prado
 */
public class LinearRecord extends File {
    ...
    public LinearRecord(byte fid, DirectoryFile parent, byte communicationSettings, byte[] accessPermissions,
